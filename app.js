...
app.get(
  "/student/course/:id/detail",
  student,
  ControllerStudent.renderDetailCourse
);
app.get(
  "/student/course/:id/unsubscribe",
  student,
  ControllerStudent.handleDeleteUserCourse
);
app.get(
  "/student/course/:id/subscribe",
  student,
  ControllerStudent.handleAddUserCourse
);
//==========================================root admin
